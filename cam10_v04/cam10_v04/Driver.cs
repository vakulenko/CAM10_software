// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam10 v.0.4
// Edit Log:
...
{
    /// <summary>
    /// ASCOM Camera Driver for cam10_v04.
    /// </summary>
    [Guid("6a51c3d1-e38b-499f-ba8e-60b979edaee4")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam10_v04.Camera";
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam10 v.0.4 ASCOM Driver";
        ...
        //Imports cam10ll04.dll functions
        [DllImport("cam10ll04.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam10_v04"/> class.
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam10ll04.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam10ll04.dll");
        ...
        public string DriverVersion
        {
            get
            {
                ...
                string driverVersion = String.Format(CultureInfo.InvariantCulture, "{0}.{4}", version.Major, version.Minor);
        ...
        public CameraStates CameraState
        {
            get
            {
                ...
                {
                    tl.LogMessage("CameraState Get", "Call cameraGetError from cam10ll04.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                else
                {
                    ...
                    uint imagepoint;
                    //Get image pointer
                    tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam10ll04.dll");
        ...
        public bool ImageReady
        {
            get
            {
                ...
                {
                    tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam10ll04.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            else
            {
                ...
                tl.LogMessage("StartExposure", "Call cameraStartExposure from cam10ll04.dll, args: ");
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam10ll04.dll");
