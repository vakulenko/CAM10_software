// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam10 v.0.5
// Edit Log:
...
{
    /// <summary>
    /// ASCOM Camera Driver for cam10_v05.
    /// </summary>
    [Guid("059e78a8-8073-48ab-9ecc-49e1a68b755c")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam10_v05.Camera";
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam10 v.0.5 ASCOM Driver";
        ...
        private const string LowLevelDll = "cam10ll05.dll";

        //Imports cam10ll05.dll functions
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam10_v05"/> class.
        ...
        public string DriverVersion
        {
            get
            {
                ...
                string driverVersion = String.Format(CultureInfo.InvariantCulture, "{0}.{5}", version.Major, version.Minor);
