...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, MyD2XX, ComCtrls, Buttons, IniFiles, Spin, Math, Cam10;
...
begin
 ...
 if bufa <> 0 then begin Memo1.Lines.Add(inttostr(bufa));
 Memo1.Lines.Add(inttostr(kbyte)+' '+inttostr(kolbyte-kbyte));end;
end;
