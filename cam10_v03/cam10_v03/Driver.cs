// --------------------------------------------------------------------------------
// ASCOM Camera driver for cam10 v.0.3
// Edit Log:
...
{
    /// <summary>
    /// ASCOM Camera Driver for cam10_v03.
    /// </summary>
    [Guid("3135a783-475b-41c3-95d2-a32a3908aab2")]
    ...
    public class Camera : ICameraV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.cam10_v03.Camera";
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Cam10 v.0.3 ASCOM Driver";
        ...
        //Imports cam10ll03.dll functions
        [DllImport("cam10ll03.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="cam10_v03"/> class.
        ...
        public bool Connected
        {
            ...
            set
            {
                ...
                if (value)
                {
                    tl.LogMessage("Connected Set", "Connecting to camera, call cameraConnect from cam10ll03.dll");
                ...
                {
                    tl.LogMessage("Connected Set", "Disconnecting from camera, call cameraConnect from cam10ll03.dll");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Information about the driver itself. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{3}", version.Major, version.Minor);
        ...
        public CameraStates CameraState
        {
            get
            {
                ...
                {
                    tl.LogMessage("CameraState Get", "Call cameraGetError from cam10ll03.dll");
                    ...
                    tl.LogMessage("CameraState Get", "Call cameraGetCameraState from cam10ll03.dll");
        ...
        public object ImageArray
        {
            get
            {
                ...
                else
                {
                    ...
                    uint imagepoint;
                    //Get image pointer
                    tl.LogMessage("ImageArray Get", "Call cameraGetImage from cam10ll03.dll");
        ...
        public bool ImageReady
        {
            get
            {
                ...
                {
                    tl.LogMessage("ImageReady Get", "Call cameraGetImageReady from cam10ll03.dll");
        ...
        public void StartExposure(double Duration, bool Light)
        {
            ...
            else
            {
                ...
                tl.LogMessage("StartExposure", "Call cameraStartExposure from cam10ll03.dll, args: ");
        ...
        private bool IsConnected
        {
            get
            {
                tl.LogMessage("IsConnected Get", "Call cameraIsConnected from cam10ll03.dll");
