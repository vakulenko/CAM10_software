...
Function Read_USB_Device_Buffer(var FT:DWord;p:pointer; Read_Count:Integer) : Integer;
Function Write_USB_Device_Buffer(var FT:DWord;Write_Count:Integer) : Integer;
function Write_USB_Device_Buffer_wErr(var FT:DWord;Write_Count : Integer ) : Boolean;
...
Function Set_USB_Device_Event_Notification(var FT: DWord;EventMask:DWord;var ev:Dword) : FT_Result;
...
// IO Buffer Sizes
    FT_In_Buffer_Size = $20000;  // 2097152*2 // 64k
...
//   FT_In_Buffer : Array[0..FT_In_Buffer_Index] of word;//Byte;
...
FT_IO_Status := FT_Read(FT,p,Read_Count,@Read_Result);
...
Function Set_USB_Device_Event_Notification(var FT: DWord;EventMask:DWord;var ev:dword) : FT_Result;
Begin
Result := FT_SetEventNotification(FT,EventMask,@ev);//FT_Event_Handle);
